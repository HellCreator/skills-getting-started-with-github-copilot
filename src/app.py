...
activities = {
    ...
    "Soccer Club": {
        "description": "Casual and competitive soccer sessions, intramural matches",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["oliver@mergington.edu", "isla@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for competitive debates and improve public speaking",
